  ...
  return (
    ...
    <div>
      ...
      <PageHeader
        ...
        title="Ambientes"
        description="Administre los ambientes de formación disponibles para horarios."
      />
          ...
          <CardContent>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input id="name" placeholder="Ej. Ambiente 301" error={!!errors.name} {...register("name")} />
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    ...
                    setEditing({ ...editing, status: e.target.value as Environment["status"] })

                  }

                >

                  {Object.entries(environmentStatusLabels).map(([value, label]) => (
                ...
                <Button
                  ...
                  onClick={() =>
                    ...
                    updateMutation.mutate({
                      ...
                      data: { name: editing.name, status: editing.status },
